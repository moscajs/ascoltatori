...
var globalCounter = 0;
MQTTAscoltatore.prototype.__defineGetter__("_client", function() {
  var that = this;
...
MQTTAscoltatore.prototype.removeListener = function removeListener(topic, callback, done) {
  var messageId = buildMessageId(topic);
...
MQTTAscoltatore.prototype.reset = function reset(done) {
  var that = this;
  if(this._client_conn !== undefined) {
    that._ascoltatore.reset();
